...
export const metadata: Metadata = {
  title: "Support - Open IPA",
  description:
    "Resources to help support Open IPA and help keep our service alive. Consider supporting us with your time or money and keep quality IPA transcription free and available for everyone.",
};
